...
public:
	VectorRR posc, dirc;
	GLdouble px, py, pz, dx, dy, dz, ux, uy, uz, pxAnterior, pzAnterior;
	...
	{
		//px = 296, py = 56, pz = -170, dx = -170, dy = 23, dz = 270;
		px = 13, py = 56, pz = 282, dx = 282, dy = 23, dz = 270;
		ux = 0, uy = 1, uz = 0;
